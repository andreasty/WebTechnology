...
2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" cliprule="evenodd"></path>
                                            </svg>
                                        </div>
                        ...
                        <section>
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="images/img-1.jpeg alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
...
1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
                            ...
                            <div class="md:flex font-sans pt-8">
                                <div class="md:shrink-0">
                                    <img src="https://www.baliaround.com/wpcontent/uploads/2014/05/kecakdance.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
                                </div>
                                <form class="p-6">
                                    <div class="flex flex-wrap">
                                        <h1 class="flex-auto font-medium text-slate-900">
